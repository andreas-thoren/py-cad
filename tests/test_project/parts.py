...
class PartialBuilderBase(BuilderABC):
    ...
    def __init__(self, dim: DimensionData):
        ...
        self.route_depth = self.dim.material_thickness / 2
        self.offset = self.dim.material_thickness - self.route_depth
    ...
    def get_bottom_panel(self) -> cq.Workplane:
        return (
            cq.Workplane("XY")
            .box(
                self.dim.x_len, self.dim.y_len, self.dim.material_thickness - self.route_depth
            )
            .faces(">Z")
            .workplane()
            .rect(
...
class PartialBuilderMid(PartialBuilderBase):
    ...
    def get_long_side_panel(self, invert_grooves=False) -> cq.Workplane:
        ...
        return (
            ...
            .rect(self.dim.material_thickness, divider_width)
            .cutBlind(-self.route_depth)
        )
